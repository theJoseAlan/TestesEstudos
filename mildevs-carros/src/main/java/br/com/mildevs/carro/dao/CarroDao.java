...
import br.com.mildevs.carros.connectionfactory.ConnectionFactory;
...
public class CarroDao {
	...
	public boolean insereCarro(Carro carro) {
		...
		try {
			...
			System.err.print("Erro ao inserir carro");
		}
		return false;
	}
	...
	public List<Carro> listaCarros(){
		...
		try {
			...
			System.err.print("Erro ao listar carros");
		}
	...
	public Carro consultaCarro(String placa) {
		...
		try {
			...
			System.err.print("Erro ao consultar carros");
		}
		return null;
	}
	...
	public boolean removeCarro(String placa) {
		...
		try {
			...
			System.err.print("Erro ao remover carro");
		}
		return false;
	}
